    ...
    switch (tab) {
      ...
      case "price":
        ...
        html = '<fieldset><legend>Spot price</legend>' +
          ...
          selectField("Zone", "price.zone", ["SE1", "SE2", "SE3", "SE4"], "SE3") +
          '<div class="field-row"><div>' +
          field("Grid tariff (öre/kWh)", "price.grid_tariff_ore_kwh", "number", 0) +
          '</div><div>' +
          ...
          'elprisetjustnu.se is free and requires no key (Sweden only). ENTSO-E covers all EU but needs a free API key.' +
          '</p>';
        break;
